...
const ProjectCard: React.FC<{ project: Project; index: number }> = ({ project, index }) => {
  ...
  return (
    <div 
      ref={ref}
      className={`flex flex-col md:flex-row gap-12 md:gap-24 items-center transition-all duration-1000 ease-out transform ${
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 overflow-x-hidden selection:bg-primary-500 selection:text-white">
      ...
      <section id="about" ref={aboutRef} className="py-32 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-12 gap-12 items-center">
            ...
            <div 
              className={`md:col-span-5 relative transition-all duration-1000 ease-bounce-out transform ${
            ...
            <div className="md:col-span-7 space-y-8 relative">
              <h2 
                className={`text-4xl md:text-6xl font-bold text-white font-display tracking-tight leading-none transition-all duration-1000 delay-300 ease-bounce-out transform ${
              ...
              <div className="space-y-6 text-gray-400 text-lg font-light leading-relaxed max-w-2xl">
                <p 
                  className={`transition-all duration-1000 delay-500 ease-bounce-out transform ${
                    isAboutVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                  }`}
                >
              ...
              <div 
                className={`pt-8 grid md:grid-cols-2 gap-8 transition-all duration-1000 delay-1000 ease-bounce-out transform ${
                  isAboutVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
              >
              ...
              <div 
                  className={`flex items-end transition-all duration-1000 delay-1000 ease-bounce-out transform ${
                    isAboutVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                  }`}
              >
            ...
            <div className="flex flex-wrap justify-center gap-6 md:gap-12 mb-16 border-b border-gray-800 pb-1">
              {skillCategories.map(tab => (
                <button
                  ...
                  className={`text-lg md:text-xl font-display transition-all duration-300 relative pb-4 -mb-1.5 border-b-2 ${
                    activeSkillTab === tab 
                    ...
                    <form className="space-y-8 transition-opacity duration-300" onSubmit={handleContactSubmit} noValidate>
                        <div className="grid grid-cols-2 gap-8">
                            <div className="space-y-2">
                                ...
                                <input 
                                    ...
                                    className={`w-full bg-transparent border-b py-3 text-white focus:outline-none transition-all duration-300 ${
                                        formErrors.name 
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea 
                                ...
                                onChange={handleInputChange}
                                className={`w-full bg-transparent border-b py-3 text-white focus:outline-none transition-all duration-300 resize-none ${
                                    formErrors.message 
                                    ? 'border-red-500 focus:border-red-500 focus:shadow-[0_10px_20px_-10px_rgba(239,68,68,0.2)]' 
                                    : 'border-gray-700 hover:border-primary-500/50 focus:border-primary-500 focus:shadow-[0_10px_20px_-10px_rgba(96,125,59,0.3)]'
                                }`} 
      ...
      <button
        ...
        className={`fixed bottom-6 right-24 z-40 p-3 rounded-full bg-gray-900/80 backdrop-blur border border-gray-700 shadow-xl text-gray-400 hover:text-primary-400 hover:border-primary-500 transition-all duration-300 transform ${
          scrollY > 500 ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0 pointer-events-none'
        }`}
